...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-4 mb-4">
      <div class="card border border-2 border-right-0" style="width: 100%;">
        <div class="text-center">
          <img src="img/akuncard1.png" class="img-fluid mt-3 rounded-circle" alt="..." style="height: 100px; margin: 0 auto;">
          <div class="card-body">
            <h6 class="text-info">Author</h6>
            <h5 class="fw-normal">Imelda Alfiana</h5>
            <button type="button" class="btn btn-outline-info">Lihat Akun</button>
            <div class="card mt-3">
              <ul class="list-group list-group-flush">
                <li class="list-group-item text-start">Panduan Menulis</li>
                <li class="list-group-item text-start">Mulai Menulis</li>
                <li class="list-group-item text-start">Draft</li>
                <li class="list-group-item text-start">Status</li>
                <li class="list-group-item text-start">Poinku</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="col-md-8 mt-4 mt-md-0">
      ...
      <!-- Card tambahan di bawah sebelah kanan -->
      <div class="card mt-4 border border-2 border-left-0" style="width: 100%;">
        <div class="row align-items-start">
          <div class="col-md-4 text-center d-flex justify-content-center">
            <img src="img/akuncard2.png" class="img-fluid mt-3" alt="..." style="height: 100px;">
          </div>
